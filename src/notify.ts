...
const PAGES_URL_DEFAULT = "https://kouweizhu.github.io/agents-radar";
...
async function sendTelegram(text: string): Promise<void> {
  ...
  if (!CHAT_ID) {
    console.log("[notify] TELEGRAM_CHAT_ID not set — skipping (no upstream-channel fallback in this fork).");
    return;
  }
